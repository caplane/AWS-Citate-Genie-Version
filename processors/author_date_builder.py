...
def generate_sort_key(metadata: SourceComponents) -> str:
    """
...
def build_references_section(
    metadata_list: List[SourceComponents],
    style: str
) -> str:
    """
...
def _get_source_key(metadata: SourceComponents) -> str:
...
def build_author_date_output(
    ...
    metadata_map: Dict[str, SourceComponents],
    style: str
) -> Tuple[List[Dict], str]:
    """
    ...
    Args:
        ...
        metadata_map: Dict mapping original text -> SourceComponents
        style: Citation style
