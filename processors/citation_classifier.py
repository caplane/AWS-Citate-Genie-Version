...
def lookup_citation(
    ...
    try:
        if input_type == CitationInputType.DOI:
            ...
            if result:
                return _book_dict_to_components(result, identifier)
            return None
...
def lookup_with_options(
    ...
    Returns:
        List of SourceComponents options
    """
    input_type = classified.input_type
...
def _book_dict_to_components(data: dict, raw_source: str) -> SourceComponents:
    """Convert book search result dict to SourceComponents."""
