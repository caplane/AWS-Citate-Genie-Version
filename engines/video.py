...
class YouTubeEngine(SearchEngine):
    ...
    def get_by_id(self, video_id: str) -> Optional[SourceComponents]:
        """
    ...
    def _normalize(self, data: dict, video_url: str, video_id: str) -> SourceComponents:
        """Convert YouTube oEmbed response to SourceComponents."""
...
class VimeoEngine(SearchEngine):
    ...
    def _normalize(self, data: dict, video_url: str, video_id: str) -> SourceComponents:
        """Convert Vimeo oEmbed response to SourceComponents."""
