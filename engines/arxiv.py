...
class ArxivEngine(SearchEngine):
    ...
    def get_by_id(self, arxiv_id: str) -> Optional[SourceComponents]:
        """
    ...
    def _normalize(self, entry: dict, raw_source: str) -> SourceComponents:
        """Convert arXiv entry to SourceComponents."""
