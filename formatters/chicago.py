...
class ChicagoFormatter(BaseFormatter):
    ...
    def _format_journal(self, m: SourceComponents) -> str:
        """
    ...
    def _format_book(self, m: SourceComponents) -> str:
        """
        Format book.
    ...
    def _format_legal(self, m: SourceComponents) -> str:
        """
        Format legal case.
    ...
    def _format_legal_short(self, m: SourceComponents) -> str:
    ...
    def _format_interview(self, m: SourceComponents) -> str:
        """
        Format interview.
    ...
    def _format_interview_short(self, m: SourceComponents) -> str:
    ...
    def _format_letter(self, m: SourceComponents) -> str:
        """
    ...
    def _format_letter_short(self, m: SourceComponents) -> str:
    ...
    def _format_newspaper(self, m: SourceComponents) -> str:
        """
    ...
    def _format_government(self, m: SourceComponents) -> str:
        """
    ...
    def _format_general_short(self, m: SourceComponents) -> str:
        """
