...
def extract_by_type(query: str, citation_type: CitationType) -> Optional[SourceComponents]:
    """
    ...
    Returns:
        SourceComponents if extraction successful, None otherwise
    """
    if not query:
        return None
...
def _extract_url(query: str) -> Optional[SourceComponents]:
...
def _extract_newspaper(query: str) -> Optional[SourceComponents]:
...
def _extract_government(query: str) -> Optional[SourceComponents]:
...
def _extract_interview(query: str) -> Optional[SourceComponents]:
...
def _extract_letter(query: str) -> Optional[SourceComponents]:
